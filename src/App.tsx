...
export const vendedorOptions = [
  "Andrés Pacheco", "Eduardo Arias", "Jorge Nario", "Lisset Santana", "Loreto Medina", "Manuel Urzúa", "Mauricio Carvajal", "Mónica Valencia", "Vendedor General CA", "Vendedor General Peg&Mort (RH)"
];
