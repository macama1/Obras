        ...
        <div className="card details">
          ...
          <div className="form-grid-details">
            ...
            <div className="form-column" style={{gridColumn: '1 / -1'}}>
              ...
              <div className="form-field"><label>Rut Empresa</label><textarea name="Rut Empresa" value={obraDetails['Rut Empresa'] || ''} onChange={handleInputChange} rows={4}></textarea></div>
