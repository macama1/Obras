...
export const vendedorOptions = [
  "Andrés Pacheco", "Eduardo Arias", "Lisset Santana", "Manuel Urzúa", "Jorge Nario", "Loreto Medina", "Mauricio Carvajal", "Mónica Valencia", "Vendedor General CA", "Vendedor General Peg&Mort (RH)"
];
